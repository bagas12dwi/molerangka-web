<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
    <a class="navbar-brand me-lg-5" href="{{ URL::asset('assets/img/favicon/logo.png') }}">
        <img class="navbar-brand-dark" src="{{ URL::asset('assets/img/favicon/logo.png') }}" alt="Simora logo" /> <img
            class="navbar-brand-light" src="{{ URL::asset('assets/img/favicon/logo.png') }}" alt="Simora logo" />
    </a>
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            <li class="nav-item">
                <a href="#" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon">
                        <img src="{{ URL::asset('assets/img/favicon/logo.png') }}" height="20" width="20"
                            alt="Volt Logo">
                    </span>
                    <span class="mt-1 ms-1 sidebar-text">MOLERANGKA Admin</span>
                </a>
            </li>
                ...
                <a href="{{ url('galeri') }}" class="nav-link">
                    <span class="sidebar-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-card-image" viewBox="0 0 20 20">
            ...
            <li class="nav-item {{ $title == 'Materi' ? 'active' : '' }} ">
                <a href="{{ url('materi') }}" class="nav-link">
                    <span class="sidebar-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-book-fill" viewBox="0 0 20 20">
                            <path
            ...
            <li class="nav-item {{ $title == 'Sub Materi' ? 'active' : '' }} ">
                <a href="{{ url('sub-materi') }}" class="nav-link">
                    <span class="sidebar-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <span class="sidebar-text">Sub Materi</span>
                </a>
            </li>
            <li class="nav-item {{ $title == 'Quiz Sub Materi' ? 'active' : '' }} ">
                <a href="{{ url('quiz-sub-materi') }}" class="nav-link">
                    <span class="sidebar-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-question-square" viewBox="0 0 20 20">
                            <path
                    ...
                    <span class="sidebar-text">Quiz Sub Materi</span>
                </a>
            </li>
            <li class="nav-item {{ $title == 'Pertanyaan' ? 'active' : '' }} ">
                <a href="{{ url('quiz') }}" class="nav-link">
                    <span class="sidebar-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-question-square-fill" viewBox="0 0 20 20">
                            <path
            ...
            <li class="nav-item {{ $title == 'Hasil Quiz Submateri' ? 'active' : '' }} ">
                <a href="{{ url('resultQuizSubmateri') }}" class="nav-link">
                    <span class="sidebar-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-journal-medical" viewBox="0 0 20 20">
                    ...
                    <span class="sidebar-text">Hasil Quiz Submateri</span>
                </a>
            </li>
            <li class="nav-item {{ $title == 'Hasil Quiz' ? 'active' : '' }} ">
                <a href="{{ url('resultQuiz') }}" class="nav-link">
                    <span class="sidebar-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-journal-medical" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                    ...
                    <span class="sidebar-text">Hasil Quiz</span>
                </a>
            </li>
        </ul>
    </div>
