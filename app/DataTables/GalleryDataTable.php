...
class GalleryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($galeri) {
                return view('pages.gallery.action', compact('galeri'));
            })
            ->addColumn('image', function ($galeri) {
                return view('pages.gallery.image', compact('galeri'));
            })
            ->addIndexColumn()
            ->setRowId('id');
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('caption')->title('Caption'),
